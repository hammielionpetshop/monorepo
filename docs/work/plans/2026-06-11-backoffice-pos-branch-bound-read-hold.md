...
```bash
npx markdownlint-cli2 apps/backoffice/CHANGELOG.md docs/work/specs/2026-06-11-backoffice-pos-branch-bound-read-hold-design.md docs/work/plans/2026-06-11-backoffice-pos-branch-bound-read-hold.md
```

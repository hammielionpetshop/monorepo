...
```bash
npx markdownlint-cli2 apps/backoffice/CHANGELOG.md docs/work/specs/2026-06-11-backoffice-pos-receiving-hardening-design.md docs/work/plans/2026-06-11-backoffice-pos-receiving-hardening.md
```
...
```bash
git diff -- apps/backoffice/app/api/pos/purchase-orders/[id]/receive apps/backoffice/CHANGELOG.md docs/work/specs/2026-06-11-backoffice-pos-receiving-hardening-design.md docs/work/plans/2026-06-11-backoffice-pos-receiving-hardening.md
```

...
| 1.2.3 | Koneksi terputus saat proses bootstrap sedang berjalan | Putus koneksi saat loading awal | Aplikasi menampilkan pesan error dalam Bahasa Indonesia dan memberikan opsi Retry | BLOCKED | Tidak dapat diuji — TC 1.2.2 FAIL menyebabkan app crash saat offline |
| 1.2.4 | Retry setelah error bootstrap | Klik tombol Retry setelah error | Aplikasi mencoba melakukan bootstrap ulang | BLOCKED | Tidak dapat diuji — TC 1.2.2 FAIL menyebabkan app crash saat offline |

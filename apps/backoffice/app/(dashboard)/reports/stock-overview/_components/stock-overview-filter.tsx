...
const SORT_OPTIONS = [
  ...
  { value: 'shortfall_desc', label: 'Utang stok terbesar' },
  { value: 'name', label: 'Nama produk A–Z' },
]

export default function StockOverviewFilter({
  categories,
  brands,
  defaultCategoryId,
  defaultBrandId,
  ...
  const [sort, setSort] = useState(defaultSort ?? 'value_desc')
  ...
  function submit() {
    ...
    if (sort && sort !== 'value_desc') params.set('sort', sort)
